...
<style>
    ...
    /* Contenedor central de las preguntas */
    .faq-section {
        max-width: 800px;
        margin: 50px auto;
        padding: 0 20px;
    ...
    .faq-item {
        ...
        transition: transform 0.3s ease, box-shadow 0.3s ease; /* Yo añado suavidad */
    }

    /* Yo añado un efecto sutil al pasar el mouse sobre la pregunta */
    .faq-item:hover {
...
<div class="faq-section">
    <div class="faq-item">
        ...
        <p>Puedes hacerlo a través de nuestro formulario de "Reserva rápida" en la página de inicio o enviándonos un mensaje directo por WhatsApp.</p>
    </div>
    ...
    <div class="faq-item">
        <h3>¿Qué sucede si necesito cancelar mi reserva?</h3>
