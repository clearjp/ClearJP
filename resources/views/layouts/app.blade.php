...
<head>
    ...
    <title>@yield('title', 'ClearJP Limpieza Profesional')</title>
    
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
    <!-- Tailwind CDN para la tarjeta de acceso -->
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; }
        ...
        body { 
            ...
            min-height: 100vh; /* Yo me aseguro de que el cuerpo ocupe toda la pantalla */
        }
        
        a { text-decoration: none; color: inherit; }
        ul { list-style: none; }
        
        /* Con flex: 1 en el main, yo logro que el footer siempre se quede abajo aunque haya poco texto */
        main { flex: 1; }

        /* --- Estilos Globales para Botones --- */
        /* Yo defino estos aquÃ­ para no tener que repetirlos en Servicios ni en Productos */
        .btn-login {
